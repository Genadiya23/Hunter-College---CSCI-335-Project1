...
int main(){
  ...
  // Example: Move all books containing the keyword "Fiction" to the cart
    moveAll("Fiction", catalog, cart);

    // Print the contents of the cart to verify
    std::cout << "Books moved: " << std::endl;
